...
function paintSettings () {
	...
	document.getElementById('slider-id-01').value = Fontsize;
	document.getElementById('slider-id-02').value = Fontweight;
}
...
function paintMap() {
	...
	localStorage.setItem('googlemapsapikeyforblock', title);
}
//So that is alwaya gets this the way it is for the next user
sdk.getData(function (data) {
	title = data.title || '';
	Fontsize = data.Fontsize|| 400;
